    ...
    render() {
        return(
               <div id="text_page">
                   ...
                   <p>Reaching Out is a non-profit company that allows many people to have access to the internet who otherwise wouldn't be able to. Our service will provide free internet and laptops to people in less wealthy areas such as Africa and the Middle East. In these places internet is far less common than in first world countries like the United States. In the 21st century, the world's modern enconomy is steadily moving towards technology focused jobs. By provding technology to these developing countries, we can help their young ones gain valuable technology experenice which they might not have otherwise recived. This will help the economies of these less developed and developing countries become more modern.</p>
               </div>
        );
    }
}
